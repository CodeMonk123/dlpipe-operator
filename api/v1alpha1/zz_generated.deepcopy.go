...
func (in *DLpipeJob) DeepCopyInto(out *DLpipeJob) {
	*out = *in
...
func (in *DLpipeJob) DeepCopy() *DLpipeJob {
	if in == nil {
		return nil
	}
	out := new(DLpipeJob)
...
func (in *DLpipeJob) DeepCopyObject() runtime.Object {
...
func (in *DLpipeJobSpec) DeepCopyInto(out *DLpipeJobSpec) {
	*out = *in
	if in.WorldSize != nil {
		in, out := &in.WorldSize, &out.WorldSize
		*out = new(int64)
		**out = **in
	}
